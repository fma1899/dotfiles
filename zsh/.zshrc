...
plugins=(git git-extras extract dirhistory docker docker-compose history mvn pip pyenv python common-aliases sudo wd command-not-found ubuntu z ssh-agent)
